...
| [playback-jitter.md](./playback-jitter.md) | The playback ring, the feeder and the adaptive pre-roll; the 2026-09-05 finding that earcons were booked as replies and inflated every reply by 300 ms |
