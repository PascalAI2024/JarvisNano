...
The board boots cleanly, but macOS curls to `192.0.2.80` still time out.
Until that is explained, camera/BLE/TTS debugging will waste time.

Current 2026-05-04 evidence: ARP resolves `192.0.2.80` to the board MAC
`XX:XX:XX:XX:XX:XX`, but ICMP and TCP port 80 time out from the Mac. Serial
