...
6. Centre vertical swipe → the ring: Jarvis/Watch/Weather/Status/(Desk while live)/Activity, wrapping; horizontal → Watch peek; `scripts/screens.py` photographs the whole walk.
